...
## Project Structure
    ...
    ├── testapiautocatalog_123247  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_123247`
...
2. Clone this repo and `cd testapiautocatalog_123247`
